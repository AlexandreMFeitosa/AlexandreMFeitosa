...
- **RANQUEADO** - (React + vite + TypeScript) - (https://www.ranqueado.com/)
   ...
   -> Plataforma web de simulados para concursos, onde atuo no desenvolvimento de interfaces responsivas, componentes reutilizáveis, integração com APIs e melhorias na experiência do usuário.. 
...
- **AJN Gases** - (React + TypeScript) - (em desenvolvimento)
   ...
   -> Projeto institucional desenvolvido com React e TypeScript, utilizando componentes modulares, roteamento e foco em escalabilidade e responsividade. 
